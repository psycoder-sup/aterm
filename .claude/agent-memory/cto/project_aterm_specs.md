...
description: Technical spec format and location conventions for the aterm project
type: project
---

Specs are stored at docs/feature/aterm/specs/m[N]-[feature-name]-spec.md. The project is greenfield -- no Swift source code exists yet as of 2026-03-24. All milestones (M1-M7) are defined in the PRD at docs/feature/aterm/aterm-prd.md.

Written specs so far:
- M3: docs/feature/aterm/specs/m3-tabs-and-spaces-spec.md (2026-03-24, v1.0)
