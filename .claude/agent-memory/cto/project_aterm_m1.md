...
M1 spec written at docs/feature/aterm/specs/m1-terminal-fundamentals-spec.md (2026-03-24).
...
- Selection implemented entirely in aterm (not from libghostty-vt)

**Why:** Greenfield project, no existing code. PRD at docs/feature/aterm/aterm-prd.md. Doc structure: docs/feature/aterm/specs/ for specs.
